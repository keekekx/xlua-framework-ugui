...
KBEngineLua.DATATYPE_INT64 = {
	...
	createFromStream = function(self, stream)
		local x = stream:readInt64()
		Dbg.WARNING_MSG("<<<<<<<<<createFromStream:INT64:" .. x)
		return x;
	end,
